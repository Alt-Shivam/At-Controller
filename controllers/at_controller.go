...
//+kubebuilder:rbac:groups=cnat.shivank.dev,resources=ats,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cnat.shivank.dev,resources=ats/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cnat.shivank.dev,resources=ats/finalizers,verbs=update
